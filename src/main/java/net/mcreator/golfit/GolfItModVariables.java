...
public class GolfItModVariables {
	...
	public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
		if (!event.getPlayer().world.isRemote) {
			...
			if (mapdata != null)
				GolfItMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayerEntity) event.getPlayer()),
	...
	public static class WorldVariables extends WorldSavedData {
		public static final String DATA_NAME = "golf_it_worldvars";
		...
		public void syncData(IWorld world) {
			...
			if (!world.getWorld().isRemote)
				GolfItMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(world.getWorld().dimension::getType),
	...
	public static class MapVariables extends WorldSavedData {
		public static final String DATA_NAME = "golf_it_mapvars";
		public double X = 0;
		public double Y = 0;
		public double Z = 0;
		public MapVariables() {
		...
		public void syncData(IWorld world) {
			this.markDirty();
			if (!world.getWorld().isRemote)
				GolfItMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new WorldSavedDataSyncMessage(0, this));
		}
