...
public class GolfBallBlockBlock extends GolfItModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.MISCELLANEOUS).sound(SoundType.CLOTH).hardnessAndResistance(1f, 10f).lightValue(0).notSolid());
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			return VoxelShapes.create(0.25D, 0D, 0.25D, 0.75D, 0.5D, 0.75D);
		}
