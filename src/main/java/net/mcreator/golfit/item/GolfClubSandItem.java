...
import net.mcreator.golfit.procedures.GolfClubSandBulletHitsBlockProcedure;
...
public class GolfClubSandItem extends GolfItModElements.ModElement {
	@ObjectHolder("golf_it:golf_club_sand")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletgolf_club_sand").setRegistryName("entitybulletgolf_club_sand"));
	}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("world", world);
					GolfClubSandBulletHitsBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
